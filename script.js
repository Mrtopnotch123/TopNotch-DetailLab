(() => {
  ...
  /*
   * Deep Reset includes the cargo area plus extraction or leather care
   * when applicable. Those options are locked to prevent duplicate charges.
  ...
  function updateBookingAddonLocks() {
    ...
    if (packageName === "Recovery") {
      ...
      note.textContent =
        "Cargo-area service, extraction, and leather care are already included when applicable.";
    } else {
      note.textContent =
